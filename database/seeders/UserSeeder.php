...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        User::insert([
            ...
            [
                "login"=>"trainer", "password"=>Hash::make("1234"), "email"=>"c.ozzy@gmail.com", "name"=>"Clara", "surname"=>"Ozzy", "registered"=>date("Y-m-d", strtotime("-10 days")), "role_id"=>2, "confirmed" => 0,
            ],
            [
                "login"=>"agatha", "password"=>Hash::make("1234"), "email"=>"forester@gmail.com", "name"=>"James", "surname"=>"Knock", "registered"=>date("Y-m-d", strtotime("-9 days")), "role_id"=>2,  "confirmed" => 0,
            ],
            [
                "login"=>"john", "password"=>Hash::make("1234"), "email"=>"doe@gmail.com", "name"=>"John", "surname"=>"Doe", "registered"=>date("Y-m-d", strtotime("-3 days")), "role_id"=>2,  "confirmed" => 0,
            ],
            [
